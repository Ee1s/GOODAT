...
def arg_parse():
    ...
    parser.add_argument('-num_pertrain',  type=int, default=80)
    parser.add_argument('-DS', help='Dataset', default='IMDB-MULTI')
    parser.add_argument('-DS_ood', help='Dataset', default='IMDB-BINARY')

...
def arg_parse():
    ...
    parser.add_argument('-lr_feat',  type=float, default=0.1)
    ...
    parser.add_argument('-DS', help='Dataset', default='ogbg-molesol')
    parser.add_argument('-DS_ood', help='Dataset', default='ogbg-molmuv')

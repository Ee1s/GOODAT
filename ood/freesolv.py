...
def arg_parse():
    ...
    parser.add_argument('-lr_adj',  type=float, default=0.0005)
    ...
    parser.add_argument('-DS', help='Dataset', default='ogbg-molfreesolv')
    parser.add_argument('-DS_ood', help='Dataset', default='ogbg-moltoxcast')

...
def arg_parse():
    ...
    parser.add_argument('-num_pertrain',  type=int, default=50)
    parser.add_argument('-DS', help='Dataset', default='ENZYMES')
    parser.add_argument('-DS_ood', help='Dataset', default='PROTEINS')
...
def flip_array(array):
    ...
    for element in array:
        flipped_array.append(1 - element)  # 将0变为1，将1变为0
...
if __name__ == '__main__':
    ...
    if args.exp_type == 'oodd':
        dataloader, dataloader_test, meta, dataloader_train = get_ood_dataset(args) 
    ...
    for trial in range(args.num_trial):    #TTA
       ...
       #setup_seed(trial + 1)
        ...
        for data in dataloader_test:
            ...
            y_score = learn_graph(data, model, args)  # 这一串是个gcn，然后更新 loss
            y_true = data.y

...
def arg_parse():
    ...
    parser.add_argument('-DS', help='Dataset', default='NCI1')
    parser.add_argument('-DS_ood', help='Dataset', default='NCI1')
...
if __name__ == '__main__':
    ...
    for epoch in range(1, args.num_pertrain):
        model.train()
        loss_all = 0
        if args.is_adaptive:
